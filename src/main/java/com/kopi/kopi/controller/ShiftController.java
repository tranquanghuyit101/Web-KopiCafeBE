...
public class ShiftController {
    ...
    public ResponseEntity<java.util.List<java.util.Map<String, Object>>> getPositionRules(@PathVariable Integer id) {
        ...
        java.util.List<java.util.Map<String, Object>> out = list.stream().map(r -> {
