...
ALTER TABLE dbo.discount_events
    ADD CONSTRAINT CK_discount_events_percent_value CHECK (discount_type <> N'PERCENT' OR discount_value <= 100);
GO
...
ALTER TABLE dbo.discount_codes
    ADD CONSTRAINT DF_discount_codes_usage_count DEFAULT (0) FOR usage_count;
GO
